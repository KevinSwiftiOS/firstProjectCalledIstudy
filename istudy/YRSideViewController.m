...
//左半边加一个按钮
    _leftBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 43, 43)];
    
    [_leftBtn setBackgroundImage:[UIImage imageNamed:@"更多选择"] forState:UIControlStateNormal];
    ...
    //写邮件的按钮
    UIButton *rightBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 43, 43)];
    [rightBtn setBackgroundImage:[UIImage imageNamed:@"写邮件"] forState:UIControlStateNormal];
...
-(void)writeEmail{
   //先初始化storyboard
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"StationLetter" bundle:nil];
    WriteLetterViewController *vc = (WriteLetterViewController *)[sb instantiateViewControllerWithIdentifier:@"writeLetterVC"];
